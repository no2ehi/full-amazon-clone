...
const Product = ({ product }: any) => {
    ...
    return (
        <div className="mt-2 grid grid-flow-col-dense grid-cols-6  border-b p-2 pb-4 last:border-none">
            <div className="flex md:items-center">
                ...
                <Image
                    ...
                    width={100}
                    height={100}
                    className="ml-4 object-contained rounded-md outline outline-1 outline-offset-2 outline-slate-300"
                    alt={product.name}
                />
            </div>
            <div className="col-span-4 md:ml-2">
